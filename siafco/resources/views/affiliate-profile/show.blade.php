        ...
        <section class="section-card">
            ...
            <form class="mt-5 grid gap-5 sm:grid-cols-2" method="post" action="{{ route('affiliate.profile.password.update') }}">
                ...
                <div class="sm:col-span-2">
                    <x-password-input name="current_password" label="Contrasena actual" autocomplete="current-password" />
                    @error('current_password')<span class="text-sm text-red-700">{{ $message }}</span>@enderror
                </div>
                <div>
                    <x-password-input name="password" label="Nueva contrasena" autocomplete="new-password" minlength="8" />
                    @error('password')<span class="text-sm text-red-700">{{ $message }}</span>@enderror
                </div>
                <div>
                    <x-password-input name="password_confirmation" label="Confirmar nueva contrasena" autocomplete="new-password" minlength="8" />
                </div>
