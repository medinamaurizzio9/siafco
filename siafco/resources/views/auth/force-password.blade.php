    ...
    <div class="mx-auto max-w-lg">
        <section class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="border-b border-slate-200 pb-4">
                ...
                <h2 class="mt-1 text-2xl font-black text-[#0b1f3a]">PROTEGE TU CUENTA</h2>
                <p class="sr-only">ACTUALIZA TU CONTRASEÑA</p>
                <p class="mt-2 text-sm text-slate-600">Estás utilizando una contraseña temporal. Crea una nueva contraseña para continuar.</p>
            </div>
